        ...
        AnimatedContent(
            ...
            when (screen) {
                ...
                is Screen.Settings -> SettingsScreen(
                    ...
                    probeEnabled = controller.probeEnabled,
                    ...
                    onToggleSync = controller::toggleSync,
                    syncFavorites = controller.syncFavorites,
                    onToggleSyncFavorites = controller::toggleSyncFavorites,
                    syncNames = controller.syncNames,
                    onToggleSyncNames = controller::toggleSyncNames,
                    syncTethered = controller.syncTethered,
                ...
                is Screen.Safety -> SafetyScreen(
                    ...
                    scanSensitivity = controller.scanSensitivity,
                    onSelectSensitivity = controller::selectScanSensitivity,
                    backgroundOn = controller.scanMode != ScanMode.OFF,
                    onToggleBackground = { on -> controller.selectScanMode(if (on) ScanMode.INTERVAL else ScanMode.OFF) },
